...
var hljs = function () {
		...
		return e.classNameAliases = i(e.classNameAliases || {}),
			function n(o, r) {
				...
				;[I, B, Z, D].forEach((e) => e(o, r)),
					...
					o.isCompiled = !0
				let c = null
				return "object" == typeof o.keywords && o.keywords.$pattern &&
					...
					(o.begin || (o.begin = /\B|\b/),
						...
						o.endsWithParent && r.terminatorEnd &&
						(a.terminatorEnd += (o.end ? "|" : "") + r.terminatorEnd)),
					o.illegal && (a.illegalRe = t(o.illegal)),
					o.contains || (o.contains = []),
					o.contains = [].concat(...o.contains.map((e) =>
						((e) => (e.variants && !e.cachedVariants &&
							...
							e.cachedVariants ? e.cachedVariants : q(e)
								? i(e, {
					...
					a.matcher = ((e) => {
						...
						return e.contains.forEach(
							(e) => t.addRule(e.begin, { rule: e, type: "begin" }),
						),
	...
	const Y = n,
		...
		ee = Symbol("nomatch"),
		te = (n) => {
			const i = Object.create(null), s = Object.create(null), o = []
			let r = !0
			const a =
			...
			function E(e, n, s, o) {
				...
				function d(e, t) {
					...
					for (; n <= i;) {
						...
						const i = _.classNameAliases[e[n]] || e[n], s = t[n]
						i ? u(s, i) : (R = s, l(), R = ""), n++
					}
				}
				function h(e, t) {
				...
				function y(i, o) {
					...
					if (
						"begin" === w.type && "end" === o.type && w.index === o.index &&
						"" === a
					) {
...
"object" == typeof exports && "undefined" != typeof module &&
	(module.exports =
		hljs) /*! `julia` grammar compiled for Highlight.js 11.10.0 */
;(() => {
	var e = (() => {
		"use strict"
		return (e) => {
